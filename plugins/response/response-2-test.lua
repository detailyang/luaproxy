...
(function query(){
  ...
  var popHtml = '<div style="z-index:10000;position:fixed;top:50%;left:50%;width:50%;max-width:500px;min-width:320px;border-radius:3px;background:white url(//example.com/upload_files/2015/05/22/FvZyVxC4C7E-h0IJGlIV-VA4L7n5.gif);-webkit-transform:translate(-50%,-60%);border: 1px solid rgba(0,0,0,.1);overflow: hidden;">' +
